        <nav class="flex items-center justify-between flex-wrap bg-gray-800 p-6 shadow-md sticky top-0">
            ...
            <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
                ...
                <div>
                    <a href="../systems/logout.php" class="inline-block text-sm px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-gray-500 hover:bg-white mt-4 lg:mt-0">Logout</a>
                </div>
            </div>
        </nav>