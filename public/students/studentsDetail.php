  ...
  <div class="flex-grow bg-gray-50 flex flex-row shadow-md">
    ...
    <main class="bg-gray-50 flex flex-col flex-1 overflow-y-scroll h-screen w-screen sc-hide scrollbar-thin scrollbar-thumb-gray-500 scrollbar-track-gray-200 p-6">
      <div class="flex items-start justify-beetween mb-6 flex-row">
        <h1 class="text-3xl text-gray-800 font-semibold w-full">Student Details - <?php echo $student['fullname']; ?></h1>
      ...
      <div class="bg-white shadow-md p-6 rounded-lg">
        ...
        <p><strong>NISN:</strong> <?php echo $student['nisn']; ?></p>
        <p><strong>Class:</strong> <?php echo $student['class_id']; ?></p>
        <p><strong>Username:</strong> <?php echo $student['username']; ?></p>
        <p><strong>Email:</strong> <?php echo $student['email']; ?></p>
        <p><strong>Role:</strong> <?php echo $student['role']; ?></p>
        <p><strong>Profile URL:</strong> <?php echo $student['profile_url']; ?></p>
        <p><strong>Created At:</strong> <?php echo date('M j, Y H:i:s', strtotime($student['created_at'])); ?></p>
        <p><strong>Updated At:</strong> <?php echo date('M j, Y H:i:s', strtotime($student['updated_at'])); ?></p>
      </div>
