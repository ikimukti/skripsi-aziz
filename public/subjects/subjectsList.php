              ...
              ?>
                <tr>
                  ...
                  <td class='py-2'>
                    ...
                    <a href="../subjects/subjectsResetPassword.php?id=<?php echo $row['id'] ?>" class='bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded inline-flex items-center text-sm'>
                      <i class='fas fa-trash mr-2'></i>
